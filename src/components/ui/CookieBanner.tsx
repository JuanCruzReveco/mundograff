        ...
        >
          <div className="flex flex-col gap-4 bg-[#0A0A0A]/90 backdrop-blur-md border border-white/10 rounded-xl p-6 shadow-2xl shadow-black/50">
            <div className="flex items-center gap-2 mb-1">
              ...
              <h3 className="text-white font-bold text-sm tracking-wide">Política de Privacidad</h3>
            </div>
            ...
            <div className="flex items-center justify-between mt-2">
              <a 
                href="/privacidad" 
                className="text-sm text-neutral-300 hover:text-white underline-offset-4 hover:underline transition-colors font-sans"
              >
                Leer más
              </a>
              ...
              <button
                ...
                className="px-5 py-2 text-sm font-bold bg-[#FF5A00] text-white rounded-lg hover:bg-[#E65000] transition-colors shadow-[0_0_15px_rgba(255,90,0,0.3)] hover:shadow-[0_0_20px_rgba(255,90,0,0.5)] active:scale-95"
              >
                Aceptar
              </button>
            </div>
